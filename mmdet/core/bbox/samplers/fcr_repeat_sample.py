...
class FCRRepeatSampler(RandomSampler):
    ...
    def _sample_pos(self, assign_result, num_expected, **kwargs):
        ...
        labels=[ 2,    3,   11,   12,   16,   19,   23,   29,   31,   33,   34,   35,
                ...
                1214, 1223, 1228]
        labels_center=[ 1,    4,    5,    7,    8,   10,   17,   18,   22,   24,   25,   26,
                        ...
                        1220, 1221, 1222, 1226, 1229]
        labels_tail=[ 0,    6,    9,   13,   14,   15,   20,   21,   30,   37,   38,   39,
                    ...
                    1189, 1203, 1204, 1205, 1213, 1215, 1218, 1224, 1225, 1227]
...
#________________________________________________________________________________________________________________________________
            ...
            if len(sampled_inds) ==0 or len(sampled_inds)==self.af:
                sampled_inds=sampled_inds
            elif  len(sampled_inds) < self.af:
                num_extra = (self.af - len(sampled_inds)) // len(sampled_inds) + 2
...
# ________________________________________________________________________________________________________________________________
            ...
            if len(sampled_inds_center) == 0 or len(sampled_inds_center) == self.ac:
                sampled_inds_center = sampled_inds_center
            elif len(sampled_inds_center) < self.ac:
                num_extra = (self.ac - len(sampled_inds_center)) // len(sampled_inds_center) + 2
                sampled_inds_center = sampled_inds_center.repeat([num_extra])
...
# ________________________________________________________________________________________________________________________________
            ...
            if len(sampled_inds_tail) == 0 or len(sampled_inds_tail) == self.ar:
                sampled_inds_tail = sampled_inds_tail
            elif len(sampled_inds_tail) < self.ar:
                num_extra = (self.ar - len(sampled_inds_tail)) // len(sampled_inds_tail) + 2
                sampled_inds_tail = sampled_inds_tail.repeat([num_extra])
