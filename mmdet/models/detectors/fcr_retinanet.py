...
class FCRRetinaNet(SingleStageDetector):
    ...
    def __init__(self,
                 ...
                 test_cfg=None,
                 pretrained=None):
        super(FCRRetinaNet, self).__init__(backbone, neck, bbox_head, train_cfg,
                                            test_cfg, pretrained)
        self.labels = labels
    ...
    def simple_test(self, img, img_metas, rescale=False):
        ...
        bbox_list, bbox_list_center, bbox_list_tail = self.bbox_head.get_bboxes(
        ...
        for bboxes, labels in bbox_list_center:
            det_bboxes_center = bboxes
            det_labels_center = labels
