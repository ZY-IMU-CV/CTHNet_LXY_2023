...
class ACSL(nn.Module):
    ...
    def __init__(self,
                 ...
                 loss_weight=1.0):
        # def __init__(self, use_sigmoid=False, score_thr=0.7,json_file='./data/lvis_v1/annotations/lvis_v1_train.json', loss_weight=1.0):
    ...
    def forward(self, cls_logits, labels, weight=None, avg_factor=None, reduction_override=None, **kwargs):
        ...
        loss_cls = torch.sum(weight_mask * cls_loss) / self.n_i
        # print("&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&")
