...
model = dict(
    ...
    roi_head=dict(
        ...
        bbox_head_tail=dict(
            ...
            loss_cls=dict(
                type='ACSL',use_sigmoid=False,score_thr=0.7, loss_weight=1.0),
            loss_bbox=dict(type='L1Loss', loss_weight=1.25)),
        bbox_head_center=dict(
            type='FcrBBoxHead',
            in_channels=256,
            fc_out_channels=1024,
            roi_feat_size=7,
...
train_cfg = dict(
    ...
    rpn_proposal=dict(
        ...
        # nms_resampling=['discrete', 0.9, 0.8, 0.7],
        nms_pre=2000,
        nms_post=2000,
        max_num=2000,
        nms_thr=0.7,
...
lr_config = dict(
    ...
    step=[16, 22])
total_epochs = 24
load_from='./work_dirs/f_lw_24_0.5_jo/epoch_24.pth'
selectp = 1
